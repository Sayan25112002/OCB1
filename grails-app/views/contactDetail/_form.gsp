<div class="form-group">
    <div class="form-inline phone-number-area">
        ...
        <div class="form-group mx-sm-3">
            <g:textField name="email" class="form-control" placeholder="Email Address" value="${details?.email}"/>
        </div>
        <div class="form-group mx-sm-3">
        ...
        <g:else>
            <button type="button" class="btn btn-primary add-new-number"><i class="fas fa-plus"></i></button>
        </g:else>
    </div>
</div>